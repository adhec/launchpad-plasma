...
Kicker.DashboardWindow {
    ...
    property color bkgColor: "#202020"
    ...
    mainItem: MouseArea {
        ...
        Rectangle {
            color: colorWithAlpha(bkgColor, plasmoid.configuration.backgroundOpacity /100)
            anchors.fill: parent
        }
        ...
        Rectangle{
            ...
            color: root.colorWithAlpha(root.textColor, 0.2)
            radius: 6
            border.color: root.colorWithAlpha(root.textColor, 0.3) //#TODO settings
            border.width: 1
        }
        ...
        Item {
            ...
            Rectangle{
                id: rectFavorites
                color: colorWithAlpha(root.bkgColor, 0.3)
                radius: 15
