...
FocusScope {
    ...
    property bool forceFocusIndex0: false
    ...
    DropArea {
        ...
        //anchors.fill: parent
        width: itemGrid.width - PlasmaCore.Units.largeSpacing // TODO cover scrollbar
        ...
        PlasmaComponents3.ScrollView {
            ...
            GridView {
                ...
                Keys.onDownPressed: {
                    if(itemGrid.currentRow() === -1 && itemGrid.count > 0 ){
                        currentIndex = 0
                    }
                    else{
